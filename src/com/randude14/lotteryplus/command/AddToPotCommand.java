...
public class AddToPotCommand implements Command {
	...
	public boolean execute(CommandSender sender, org.bukkit.command.Command cmd, String[] args) {
		...
		if(args.length < 2) {
			return ChatUtils.sendCommandHelp(sender, Perm.ADD_TO_POT, "/%s [addtopot/atp] <lottery name> <money> - add money to a lotteries pot", cmd);
		}
	...
	public void getCommands(CommandSender sender, org.bukkit.command.Command cmd) {
		ChatUtils.sendCommandHelp(sender, Perm.ADD_TO_POT, "/%s [addtopot/atp] <lottery name> <money> - add money to a lotteries pot", cmd);
	}
