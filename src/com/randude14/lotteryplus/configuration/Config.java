...
public class Config {
	...
	public static final Property<String> BUY_MESSAGE = new Property<String>("properties.buy-message", "&e[Lottery+] - <player> has bought <tickets> tickets for <lottery>.");
	...
	public static final Property<String> WARNING_MESSAGE = new Property<String>("properties.warning-message", "&e[Lottery+] - There are <time> left until the drawing occurs for <name>.");
